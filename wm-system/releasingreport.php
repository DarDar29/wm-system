...
<header class="header-section text-center">
            ...
            <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="details" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item">
                            <a href="#Releasing-Report" class="sidebar-link">Releasing Report</a>
                        </li>
                        <li class="sidebar-item">
    ...
    <div class="main--content">
        ...
        <div class="card-container">
            <h3 class="main-title">Generate Delivery Report</h3>
            <form action="" id=form method="post">
            <label for="supplygroup">Releasing Groups:</label>
            <select name="supplygroup" id="supplygroup" >
                <option value="" style="text-align:center;">Select Group</option>
            ...
            <label for="itemtype">From:</label>
  <input type="date" id="itemtype" name="itemtype">
  <label for="class">To:</label>
  <input type="date" id="class" name="class">
  
  <label for="price">Released Type:</label>
  <select name="supplygroup" id="supplygroup" >
                <option value="" style="text-align:center;">Select Status</option>
                <option value="">For Adjustment</option>
                <option value="">For Disposal</option>
                <option value="">For Operation</option>
                
                
            </select>
  <label for="price">Issued To:</label>
  <select name="supplygroup" id="supplygroup" >
                <option value="" style="text-align:center;">Select Group</option>
                <option value="">ss</option>
                <option value="">ss</option>
  ...
  <label for="price">Issued By:</label>
  <select name="supplygroup" id="supplygroup" >
                <option value="" style="text-align:center;">Select Group</option>
                <option value="">ss</option>
                <option value="">ss</option>
