            ...
            <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="details" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item">
                            <a href="#Equipment Report" class="sidebar-link">Equipments Report</a>
                        </li>
                        <li class="sidebar-item">
    ...
    <div class="main--content">
        <div class="header--wrapper">
            <div class="header--title">
                ...
                <h2>Equipments Report</h2>
                
            </div>
       
        </div>
        <div class="card-container search_select_box">
            <h3 class="main-title">Generate Equipments Report</h3>
            <form action="" id=form method="post">
            <label for="supplygroup">Equipment Groups:</label>
            <select name="supplygroup" id="supplygroup" data-live-search="true" >
